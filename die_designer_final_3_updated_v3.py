...
st.sidebar.write(f"Open Area of One Hole: {open_area_one_hole:.2f} mm²")
st.sidebar.write(f"Total Plate Open Area: {total_open_area:.0f} mm²")
st.sidebar.write(f"Open Area per Tonne: {open_area_per_tonne:.0f} mm²/t/h")
